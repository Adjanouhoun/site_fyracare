...
final class PageEditorController extends AbstractController
{
    ...
    private const SECTIONS = [
        ...
        'founder'=>'Notre expertise — Aminata', 'experience'=>'L’expérience FyraCare',
        'appointment'=>'Appel à l’action', 'gallery'=>'Présentation de la galerie',
    ...
    private const STRUCTURE = [
        'home'=>[
            ...
            'journal'=>['advice_page.featured_*'], 'appointment'=>['appointment.*'],
        ],
        'about'=>[
